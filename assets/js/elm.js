...
var _user$project$Types$ContactList = F4(
	function (a, b, c, d) {
		return {entries: a, page_number: b, total_entries: c, total_pages: d};
	});
var _user$project$Types$Contact = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
										_elm_lang$core$Json_Decode$succeed(_user$project$Types$Contact),
...
var _user$project$Decoders$contactListDecoder = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$Types$ContactList),
				A2(
					_elm_lang$core$Json_Decode$field,
					'entries',
...
var _user$project$ContactList_View$paginationList = function (model) {
	var totalPages = model.contactList.total_pages;
	var pageNumber = model.contactList.page_number;
	return A2(
		_elm_lang$html$Html$ul,
		{
			ctor: '::',
...
var _user$project$ContactList_View$indexView = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$ContactList_View$paginationList(model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"FetchResult":["Result.Result Http.Error Types.ContactList"],"HandleSearchInput":["String"],"HandleFormSubmit":[],"Paginate":["Int"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.ContactList":{"args":[],"type":"{ entries : List Types.Contact , page_number : Int , total_entries : Int , total_pages : Int }"},"Types.Contact":{"args":[],"type":"{ id : Int , first_name : String , last_name : String , gender : Int , birth_date : String , location : String , phone_number : String , email : String , headline : String , picture : String }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
